...
const OrderPage = () => {
	...
	const [selectButtonType, setSelectButtonType] = React.useState('Tất cả đơn hàng');
				...
				<Card stretch data-tour='list'>
						...
						<CardLabel
							...
							<CardTitle
								...
								<Button
									...
									onClick={() => setSelectButtonType('Tất cả đơn hàng')}>
									Tất cả đơn hàng
								</Button>
								<Button
									color='info'
									isLight
									style={{ marginRight: 4 }}
									onClick={() => setSelectButtonType('Đơn hàng đang xử lý')}>
									Đơn hàng đang xử lý
								</Button>
								<Button
									color='info'
									isLight
									style={{ marginRight: 4 }}
									onClick={() => setSelectButtonType('Đơn hàng đã duyệt')}>
									Đơn hàng đã duyệt
								</Button>
								<Button
									color='info'
									isLight
									style={{ marginRight: 4 }}
									onClick={() => setSelectButtonType('Đơn hàng đang vận chuyển')}>
								...
								<Button
									...
									isLight
									style={{ marginRight: 4 }}
									onClick={() => setSelectButtonType('Đơn hàng đã hoàn thành')}>
								...
								<Button
									...
									isLight
									style={{ marginRight: 4 }}
									onClick={() => setSelectButtonType('Đơn hàng đã huỷ')}>
									Đơn hàng đã huỷ
								</Button>
							</CardTitle>
						</CardLabel>
						<CardActions style={{ display: 'flex', flexWrap: 'nowrap' }}>
							<Button
								color='info'
								icon='CloudDownload'
								isLight
					...
					<CardBody className='table-responsive' isScrollable>
						<table className='table table-modern table-hover'>
							...
							<tbody>
								{selectButtonType === 'Tất cả đơn hàng' &&
									onCurrentPageItems.map((item) => (
										<tr key={item.id}>
											...
											<td>
												{parseInt(item.t_price, 10).toLocaleString(
													'it-IT',
													{
														style: 'currency',
														currency: 'VND',
								...
								{selectButtonType === 'Đơn hàng đang xử lý' &&
									onCurrentPageItems.map((item) => {
								...
								{selectButtonType === 'Đơn hàng đã duyệt' &&
									onCurrentPageItems.map((item) => {
								...
								{selectButtonType === 'Đơn hàng đang vận chuyển' &&
									onCurrentPageItems.map((item) => {
								...
								{selectButtonType === 'Đơn hàng đã hoàn thành' &&
									onCurrentPageItems.map((item) => {
								...
								{selectButtonType === 'Đơn hàng đã huỷ' &&
									onCurrentPageItems.map((item) => {
